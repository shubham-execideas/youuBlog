...
emailContactValidation && emailContactValidation.addEventListener(
  "keyup",
  function () {
...
submitButtonContact && submitButtonContact.addEventListener("click", function () {
  //  newsletterSubmit = () => {
...
emailValidation && emailValidation.addEventListener("keyup", function () {
...
twitterShare && twitterShare.addEventListener("click", function () {
...
linkedinShare && linkedinShare.addEventListener("click", function () {
  let url = encodeURI(window.location.href);
...
facebookShare && facebookShare.addEventListener("click", function () {
  let url = encodeURI(window.location.href);
...
let emailInput;
emailFieldC && emailFieldC.addEventListener("keyup", function () {
...
let urlPathnames = [
                " ", "/about/", "/our-team/", "/contact/", "/support/", "/blog/", "/news/"
            ]
