...
!(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    c || new cookieNoticeJS();
  }),
    (window.cookieNoticeJS = function () {
      if (
        void 0 === c &&
        ((c = this), -1 == document.cookie.indexOf("cookie_notice"))
      ) {
        var t = document.querySelector("script[ data-cookie-notice ]");
        try {
          o = t ? JSON.parse(t.getAttribute("data-cookie-notice")) : {};
        } catch (e) {
          console.error("data-cookie-notice JSON error:", t, e), (o = {});
        }
        ...
        var e,
          ...
          r = (function (e, t, o, i, n, r) {
            ...
            (n = void 0 !== n ? n : "12px"),
              (a.innerHTML = e + "&nbsp;"),
              a.setAttribute("id", "cookieNotice"),
              a.setAttribute("data-test-section", "cookie-notice"),
              a.setAttribute("data-test-transitioning", "false"),
              (s.position = "fixed"),
              "top" === r
                ? ((r = document.querySelector("body")),
                  (l = r.style.paddingTop),
                  (s.top = "0"),
                  (r.style.paddingTop = u + "px"))
                : (s.bottom = "0");
            (s.left = "0"),
              (s.right = "0"),
              (s.background = t),
            ...
            n.fontFamily,
            n.fontSize,
            n.cookieNoticePosition
          );
        n.learnMoreLinkEnabled &&
          ((a = d(n.learnMoreLinkText)),
          (e = a),
          (t = n.learnMoreLinkHref),
          (o = n.linkTarget),
          (i = n.linkColor),
          n.linkBgColor,
          ...
          (s.title = e),
          (s.target = o),
          (s.className = "learn-more"),
          s.setAttribute("data-test-action", "learn-more-link"),
          (a.color = i),
        ...
        var a = (function (e, t, o, i) {
          ...
          (n.href = "#"),
            ...
            (n.className = "confirm"),
            n.setAttribute("data-test-action", "dismiss-cookie-notice"),
            (r.background = t),
            (r.color = o),
        ...
        a.addEventListener("click", function (e) {
          var t, o, i;
          e.preventDefault(),
            (t = 60 * parseInt(n.expiresIn + "", 10) * 1e3 * 60 * 24),
            (o = new Date()),
            (e = new Date()).setTime(o.getTime() + t),
            (document.cookie =
              "cookie_notice=1; expires=" + e.toUTCString() + "; path=/;"),
            ((i = r).style.opacity = 1),
            i.setAttribute("data-test-transitioning", "true"),
            (function e() {
              (i.style.opacity -= 0.1) < 0.01
                ? (void 0 !== l &&
                    (document.querySelector("body").style.paddingTop = l),
                  document.body.removeChild(i))
                : setTimeout(e, 40);
            })();
        });
        var s = document.body.appendChild(r);
        i && s.appendChild(i), s.appendChild(a);
      }
    });
})();
